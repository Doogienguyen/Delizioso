                    ...
                    <div className="col-md-6">
                        <form onSubmit={this.formSubmit}>
                            ...
                            <div className="form-group">
                                ...
                                <textarea className="form-control" rows="5" value={this.state.directions} onChange={this.onDirectionsChange} type="text" placeholder="Ex: Boil water, Cook for 10mins"></textarea>
                            </div>
                            <div className="form-group">
