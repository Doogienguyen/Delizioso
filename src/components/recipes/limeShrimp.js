    ...
    render() {
        return (
            <div className="container">
                ...
                <div className="row">
                    <div className="col" >
                        <h2 class="ingredients-header">Cilantro Lime Shrimp with Zucchini Noodles<button type="button" class="btn btn-outline-success btn-sm toggle" data-toggle="button" aria-pressed="false" autocomplete="off">
                            Favorite </button></h2>
