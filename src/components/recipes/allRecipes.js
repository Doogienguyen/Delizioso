            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div id="healthy" className="row"><a name="healthy"></a>
                        <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6" onClick={() => { this.props.changePath(LIMESHRIMP) }}>
                    ...
                    <div id="pastas" className="row"><a name="pastas"></a>
                        <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6" onClick={() => { this.props.changePath(PESTOPASTA) }}>
                    ...
                    <div id="hearty" className="row"><a name="hearty"></a>
                        <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6" onClick={() => { this.props.changePath(LASAGNA) }}>
                    ...
                    <div id="dessert" className="row"><a name="desserts" />
                        <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6" onClick={() => { this.props.changePath(TIRAMISU) }}>
