        ...
        return (
                ...
                <div>
                    ...
                    <div class="row">
                        ...
                        <h4 class="ingredients-header">Cilantro Lime Shrimp with Zucchini Noodles</h4>
                        ...
                        <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6">
                        <h4 class="ingredients-header">Spinach Ravioli with Zucchini Ribbons</h4>
                            <img src="http://images.media-allrecipes.com/userphotos/960x960/3758232.jpg" class="img-responsive" />
                        </div>

                        <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6">
                        <h4 class="ingredients-header">Lemon Chicken Pasta with Garlic Cream Sauce</h4>
                        ...
                        <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6">
                        <h4 class="ingredients-header">Spaghetti with Clam and Garlic</h4>
                        ...
                        <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6">
                        <h4 class="ingredients-header">Proscuitto and Arugala Pizza</h4>
